    ...
    <div className="w-full bg-gradient-to-r from-purple-900 via-black to-purple-900 text-white py-2 px-4 text-center text-xs sm:text-sm font-medium relative overflow-hidden z-50">
        ...
        <div className="relative z-10 flex items-center justify-center gap-2">
            <span className="bg-gradient-to-r from-yellow-400 to-orange-500 text-black text-[10px] px-2 py-0.5 rounded-full font-bold uppercase tracking-wider">
                Banana Pro foi lançado!
            </span>
            <span className="text-gray-200">|</span>
            <span className="font-semibold tracking-wide">PROMOÇÃO DE BLACK FRIDAY</span>
...
const Navbar = () => (
    <nav className="w-full flex items-center justify-between px-6 py-4 md:px-12 sticky top-0 z-50 bg-black/50 backdrop-blur-md border-b border-white/5">
        ...
        <div className="hidden md:flex items-center gap-8">
            {['Casos de uso', 'Ferramentas de IA', 'Recursos'].map((item) => (
            ...
            <Link href="/blog" className="text-gray-400 hover:text-white text-sm font-medium transition-colors">Blog</Link>
        ...
        <div className="min-h-screen bg-black text-white flex flex-col font-sans selection:bg-purple-500/30">
            ...
            <main className="flex-1 flex flex-col items-center pt-16 pb-20 px-4 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto">
                    ...
                    >
                        #1 Agente de Vídeo para Marketing
                    </span>
                    ...
                    >
                        <div className="px-4 py-3">
                            <input
                                type="text"
                                placeholder="Envie a imagem do produto ou vídeo de referência e descreva sua ideia..."
